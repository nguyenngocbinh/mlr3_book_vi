...
```{r 05-technical-031, R.options=list(width = 120)}
as.data.table(parA)
```
...
```{r 05-technical-035, R.options=list(width = 120)}
as.data.table(ps)
```
...
```{r 05-technical-048, echo = FALSE, out.width="45%", fig.show = "hold", fig.width = 4, fig.height = 4}
par(mar=c(4, 4, 2, 1))
